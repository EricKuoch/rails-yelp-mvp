...
restaurant1 = Restaurant.create!(name: 'Le Rocher', address: 'Rue du Nord Grand Baie', category: 'italian')
restaurant2 = Restaurant.create!(name: 'Supriz', address: 'Oberkamp', category: 'french' )
